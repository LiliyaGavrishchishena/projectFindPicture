...
export default class View {
  constructor() {
    ...
    this.refs.listFavorites = document.querySelector(
      ".picture__list.favorites__list"
    );
  ...
  init(items) {
    this.refs.pictList.innerHTML = this.createCard(items);
  }

  add(items) {
    this.refs.pictList.innerHTML = this.refs.pictList.innerHTML + this.createCard(items);
  }

export default class Controller {
  constructor(model, view) {
    ...
    this._view.refs.close.addEventListener("click", this.popUpClose.bind(this));
    this._view.refs.next.addEventListener("click", this.popUpNext.bind(this));
    this._view.refs.prev.addEventListener("click", this.popUpPrev.bind(this));
